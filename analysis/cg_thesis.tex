...
highlight that reforms ``activated'' disclosure in a weak institutional
setting, with policy implications for emerging markets emphasizing
practices over mere disclosure.
...
\caption{NPL Ratio vs Corporate Governance Disclosure Index (CGDI): Pre-2015 (blue, flat) vs Post-2015 (red, steep negative). The graph shows a clear structural break in the relationship after the 2014--2016 CBN reforms. Before 2015, higher CGDI scores had no visible impact on NPLs (near-flat blue trend). After 2015, the same increase in CGDI is associated with a sharp decline in NPLs (steep red trend), confirming that the reforms ``activated'' disclosure as a meaningful signal of governance quality.}
\label{fig:scatter}
\end{figure}
